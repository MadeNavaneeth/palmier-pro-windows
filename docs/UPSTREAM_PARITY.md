...
| PRs #535, #539, #540, #541 | Keyframe lanes; animated text size and blur; audio keyframe controls | Planned | No keyframe model exists â€” clip properties are static scalars. Requires a per-property animation track contract shared by preview, export, and Agent before any of these can land |
