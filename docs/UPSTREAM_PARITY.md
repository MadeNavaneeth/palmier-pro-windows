...
| PRs #518, #511, #510, #506, #476, #479, #490, #557, #564, #513 | Captions/transcripts cluster (SRT/VTT import, caption preview, length limits, outline/gap/highlight fixes, transcript-first index, cancellation) | Partial | The import-and-display half landed since this row was written: SRT and WebVTT import create cue clips on a track (`import_srt`/`import_vtt` tools included), cues render in preview and export, and a WebVTT sidecar is written beside the output (R3). What remains is everything downstream of transcription â€” transcript-first index (#506), generation timing/limits (#511/#510), outline/gap/highlight rendering refinements (#476/#479/#490/#557/#564/#513) â€” blocked by the absent transcription subsystem (#39/#91/#252/#287) |
